...
import { Database, User, Lock, RefreshCw } from 'lucide-react';
...
const Auth: React.FC<AuthProps> = ({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-950 p-4 font-sans selection:bg-indigo-500/30">
      <div className="max-w-md w-full rounded-3xl bg-slate-900 border border-white/10 shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-500">
